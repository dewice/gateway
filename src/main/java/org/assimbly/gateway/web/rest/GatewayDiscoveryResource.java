...
import org.assimbly.gateway.web.rest.vm.RouteVM;
...
public class GatewayDiscoveryResource {

    private final RouteLocator routeLocator;

    private final DiscoveryClient discoveryClient;

    public GatewayDiscoveryResource(RouteLocator routeLocator, DiscoveryClient discoveryClient) {
