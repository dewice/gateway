 ...
 */
@Mapper(componentModel = "spring", uses = {FromEndpointMapper.class, ErrorEndpointMapper.class, GatewayMapper.class, DeploymentMapper.class})
public interface FlowMapper extends EntityMapper<FlowDTO, Flow> {
    ...
    @Mapping(source = "deploymentId", target = "deployment")
