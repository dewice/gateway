...
public class FlowMapperImpl implements FlowMapper {
    ...
    @Override
    public List<Flow> toEntity(List<FlowDTO> dtoList) {
        if ( dtoList == null ) {
            return null;
        }

        List<Flow> list = new ArrayList<Flow>( dtoList.size() );
        for ( FlowDTO flowDTO : dtoList ) {
    ...
    @Override
    public List<FlowDTO> toDto(List<Flow> entityList) {
        if ( entityList == null ) {
            return null;
        }

        List<FlowDTO> list = new ArrayList<FlowDTO>( entityList.size() );
        for ( Flow flow : entityList ) {
            list.add( toDto( flow ) );
        }
