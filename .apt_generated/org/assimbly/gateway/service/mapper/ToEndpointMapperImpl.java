...
public class ToEndpointMapperImpl implements ToEndpointMapper {
    ...
    @Override
    public List<ToEndpoint> toEntity(List<ToEndpointDTO> dtoList) {
        if ( dtoList == null ) {
            return null;
        }

        List<ToEndpoint> list = new ArrayList<ToEndpoint>( dtoList.size() );
        for ( ToEndpointDTO toEndpointDTO : dtoList ) {
    ...
    @Override
    public List<ToEndpointDTO> toDto(List<ToEndpoint> entityList) {
        if ( entityList == null ) {
            return null;
        }

        List<ToEndpointDTO> list = new ArrayList<ToEndpointDTO>( entityList.size() );
        for ( ToEndpoint toEndpoint : entityList ) {
